...
class Request
{
     ...
     * @return int
     */
    public static function getResponeCode()
    {
        return self::$history;
    }
     ...
     * @return bool
     */
    public static function get($url, $fields = array(), $allow_redirects = true)
    {
        self::init ();
        return self::request($url, 'get', $fields, NULL, $allow_redirects);
    }
     ...
     * @access public
     */
    public static function post($url, $fields = array(), $files = array(), $allow_redirects = true)
    {
        self::init ();
        return self::request($url, 'POST', $fields, $files, $allow_redirects);
    }
     ...
     * @created time :2017-08-03 18:06
     */
    public static function request($url, $method = 'GET', $fields = array(), $files = array(), $allow_redirects = true)
    {
