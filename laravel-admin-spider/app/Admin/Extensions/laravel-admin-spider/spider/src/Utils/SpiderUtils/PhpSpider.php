...
namespace Linsvert\Spider\Utils\SpiderUtils;

use Exception;
use Linsvert\Spider\Utils\SpiderUtils\Db;
use Linsvert\Spider\Utils\SpiderUtils\Log;
use Linsvert\Spider\Utils\SpiderUtils\Queue;
use Linsvert\Spider\Utils\SpiderUtils\Request;
use Linsvert\Spider\Utils\SpiderUtils\Selector;
use Linsvert\Spider\Utils\SpiderUtils\Util;
...
class PhpSpider
{
    ...
    public function start()
    {
        ...
        if (Log::$log_show)
        {
            ...
            $header .= '  * PHPSpider Version: '.self::PHPSPIDER_VERSION."\n";
    ...
    public function request_url($url, $link = array())
    {
        ...
        {
            Request::$input_encoding = self::$configs['input_encoding'];
        }
        // 得到的编码如果不是utf-8的要转成utf-8, 因为xpath只支持utf-8
        Request::$output_encoding = 'utf-8';
        Request::set_timeout(self::$configs['timeout']);
        Request::set_useragent(self::$configs['user_agent']);
        ...
        {
            Request::set_client_ip(self::$configs['client_ip']);
        }
    ...
    public function display_ui()
    {
        ...
        $display_str .= 'PHPSpider version:'.self::PHPSPIDER_VERSION.'          PHP version:'.PHP_VERSION."\n";
